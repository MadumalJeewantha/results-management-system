...
<div class="row">
        <div class="col-lg-12">
                ...
                <h4>Emp. Number : <strong>{{$lecture->employee_id}}</strong></h4>
                <h4>Name : <strong>{{$lecture->first_name}}</strong>&nbsp;<strong>{{$lecture->last_name}}</strong></h4>
    ...
    <div class="row">
        ...
        {!! Form::open(['action' => ['ProfilesController@updateLectureProfile', $lecture->employee_id] , 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class'=> 'form-horizontal']) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group{{ $errors->has('department_id') ? ' has-error' : '' }}">
                                            ...
                                            <div class="controls col-sm-9">
                                                <select id="department_id" class="form-control" data-role="select" selected="selected" required="required" name="department_id" disabled>
