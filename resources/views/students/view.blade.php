...
<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
               Student: <strong>{{$student->student_registration_number}} </strong>
               <a href="/students" class="btn btn-default pull-right" style="margin:5px">Back</a>

               @if( (Auth()->user()->type) == 'dean' || (Auth()->user()->type) == 'ar')            
                    {{-- Edit button --}}
                    <a href="/students/{{$student->student_registration_number}}/edit" class="btn btn-primary pull-right" style="margin:5px">Edit</a>
                    ...
                    <div id="panel1" class="panel panel-default" data-role="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                             ...
                             <!--Back Button-->
                        <a href="/students" class="btn btn-default pull-right" > Back</a>
                        </div>
