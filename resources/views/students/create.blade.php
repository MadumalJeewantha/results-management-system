...
<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
               Add New Student <a href="/students" class="btn btn-default pull-right">Back</a>
            </h1>
            ...
            <ol class="breadcrumb">
                    <li>
                     ...
                     <li>
                        <i class="glyphicon glyphicon-user"></i>  <a href="/students">Students</a>
                    </li>
                     <li class="active">
    ...
    <div class="row">
        ...
        {!! Form::open(['action' =>'StudentsController@store' , 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class'=> 'form-horizontal']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('student_registration_number') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="student_registration_number" class="form-control k-textbox" data-role="text" required="required" placeholder=" Registration  Number" name="student_registration_number" type="text" value="{{ old('student_registration_number') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('department_id') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <select id="department_id" class="form-control" data-role="select" name="department_id" >
                                    ...
                                    <div class="form-group{{ $errors->has('academic_year_id') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <select id="academic_year_id" class="form-control" data-role="select" required="required"  name="academic_year_id">
                                                @foreach($academicYears as $academicYear)
                                                    <option value="{{$academicYear->academic_year_id}}" {{ (Illuminate\Support\Facades\Input::old("academic_year_id") == $academicYear->academic_year_id ? "selected": "") }}>
                                                        {{$academicYear->year}}
                                                    </option>                                                
                                                @endforeach                                                
                                            </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('student_index_number') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="student_index_number" required="required" class="form-control k-textbox" data-role="text" placeholder="Index Number" name="student_index_number" type="text" value="{{ old('student_index_number') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('course_id') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <select id="course_id" class="form-control" data-role="select"  required="required" name="course_id">
                                                @foreach($courses as $course)
                                                    <option value="{{$course->course_id}}" {{ (Illuminate\Support\Facades\Input::old("course_id") == $course->course_id ? "selected": "") }}>
                                                        {{$course->name}}
                                                    </option>                                                
                                                @endforeach 
                                            </select>
                                    ...
                                    <div class="form-group{{ $errors->has('specialized_area_id') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <select id="specialized_area_id" class="form-control" data-role="select"  name="specialized_area_id">
                                               
                                                @foreach($specializedAreas as $specializedArea)
                                                    <option value="{{$specializedArea->specialized_area_id}}" {{ (Illuminate\Support\Facades\Input::old("specialized_area_id") == $specializedArea->specialized_area_id ? "selected": "") }}>
                            ...
                            <div class="row" style="display: block;">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('initials') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="initials" required="required" class="form-control k-textbox" data-role="text" placeholder="Initials" name="initials" type="text" value="{{ old('initials') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}" style="display: block;">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="first_name" class="form-control k-textbox" data-role="text" required="required" placeholder="First Name" name="first_name" type="text" value="{{ old('first_name') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('contact_no_mobile') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="contact_no_mobile" maxlength="10" class="form-control k-textbox" data-role="text" placeholder="Mobile Number" name="contact_no_mobile"  type="text" value="{{ old('contact_no_mobile') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('contact_no_home') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="contact_no_home" maxlength="10" class="form-control k-textbox" data-role="text" placeholder="Home Contact Number" name="contact_no_home"  type="text" value="{{ old('contact_no_home') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('nic_number') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="nic_number" class="form-control k-textbox" data-role="text" required="required" placeholder="National Identity Card Number" data-parsley-minwords="10" name="nic_number" type="text" value="{{ old('nic_number') }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="date_of_birth" class="form-control k-textbox" data-role="text" required="required" placeholder="Date of Birth"  name="date_of_birth" type="date" value="{{ old('date_of_birth') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('marriage_state') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            ...
                                            <label class="radio" for="unmarried">
                                                    <input value="Unmarried" id="unmarried" name="marriage_state" checked="checked" required="required" type="radio" {{ (Illuminate\Support\Facades\Input::old("marriage_state") == 'Unmarried' ? "checked": "") }}>
                                                    Un-married
                                            </label>

                                            <label class="radio" for="married">
                                                <input value="Married" id="married" name="marriage_state"  required="required" type="radio" {{ (Illuminate\Support\Facades\Input::old("marriage_state") == 'Married' ? "checked": "") }}>
                                                Married
                                            </label>       
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group{{ $errors->has('home_address_1') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="home_address_1" class="form-control k-textbox" data-role="text" placeholder="Number" name="home_address_1"  type="text" value="{{ old('home_address_1') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('home_address_2') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="home_address_2" class="form-control k-textbox" data-role="text" name="home_address_2" placeholder="Street" type="text" value="{{ old('home_address_2') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('home_address_3') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="home_address_3" class="form-control k-textbox" data-role="text" name="home_address_3" placeholder="City" type="text" value="{{ old('home_address_3') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('current_address_1') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="current_address_1" class="form-control k-textbox" data-role="text" placeholder="Number" name="current_address_1" type="text" value="{{ old('current_address_1') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('current_address_2') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="current_address_2" class="form-control k-textbox" data-role="text" placeholder="Street" name="current_address_2"  type="text" value="{{ old('current_address_2') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('current_address_3') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="current_address_3" class="form-control k-textbox" data-role="text" placeholder="City" name="current_address_3" type="text" value="{{ old('current_address_3') }}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group{{ $errors->has('fb_url') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="fb_url" class="form-control k-textbox" data-role="text" placeholder="Facebook Profile URL" name="fb_url" type="text" value="{{ old('fb_url') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('linkedin_url') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="linkedin_url" class="form-control k-textbox" data-role="text" placeholder="Linkedin Profile URL" name="linkedin_url" type="text" value="{{ old('linkedin_url') }}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group{{ $errors->has('father_name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="father_name" class="form-control k-textbox" data-role="text" placeholder="Father's Name" name="father_name"  type="text" value="{{ old('father_name') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('father_occupation') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="father_occupation" class="form-control k-textbox" data-role="text" placeholder="Father's Occupation" name="father_occupation"  type="text"value="{{ old('father_occupation') }}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group{{ $errors->has('mother_name') ? ' has-error' : '' }}" style="display: block;">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="mother_name" class="form-control k-textbox" data-role="text" placeholder="Mother's Name" name="mother_name" type="text" value="{{ old('mother_name') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('mother_occupation') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="mother_occupation" class="form-control k-textbox" data-role="text" placeholder="Mother's Occupation" name="mother_occupation"  type="text" value="{{ old('mother_occupation') }}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group{{ $errors->has('number_of_sisters_and_brothers') ? ' has-error' : '' }}" style="display: block;">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="number_of_sisters_and_brothers" class="form-control k-textbox" data-role="text" placeholder="Number of Brothers &amp; Sisters" name="number_of_sisters_and_brothers"  type="text" value="{{ old('number_of_sisters_and_brothers') }}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group{{ $errors->has('dissertation_title') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="dissertation_title" class="form-control k-textbox" data-role="text" placeholder="Dissertation Title" name="dissertation_title" type="text" value="{{ old('dissertation_title') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('supervisor_name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="supervisor_name" class="form-control k-textbox" data-role="text" placeholder="Supervisor Name" name="supervisor_name" type="text" value="{{ old('supervisor_name') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('dissertation_published_link') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="dissertation_published_link" class="form-control k-textbox" data-role="text" name="dissertation_published_link" placeholder="Published Link" type="text" value="{{ old('dissertation_published_link') }}">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div> 
                                        <br> 
                                        <button type="submit" style="margin:5px" class="btn btn-success pull-right">Save</button>
