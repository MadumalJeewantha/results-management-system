...
<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
               Edit Student: <strong>{{$student->student_registration_number}}</strong> 
               
               <a href="/students" class="btn btn-default pull-right" style="margin:5px">Back</a>

               @if( (Auth()->user()->type) == 'dean' || (Auth()->user()->type) == 'ar')            
                {{-- Delete button --}}
                <button type="button" data-id="{{ $student->student_registration_number }}" class="delete-modal btn btn-danger pull-right" style="margin:5px" data-id="{{ $student->student_registration_number }}">
                        Delete
                </button>
               @endif
            </h1>
    ...
    <div class="row">
        ...
        {!! Form::open(['action' => ['StudentsController@update', $student->student_registration_number] , 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class'=> 'form-horizontal']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('department_id') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <select id="department_id" class="form-control" data-role="select" selected="selected" name="department_id">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('student_index_number') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="student_index_number" required="required" class="form-control k-textbox" data-role="text" placeholder="Index Number" name="student_index_number" type="text" value="{{ $student->student_index_number }}">
                                    ...
                                    <div class="form-group{{ $errors->has('specialized_area_id') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <select id="specialized_area_id" class="form-control" data-role="select" selected="selected" name="specialized_area_id">
                            ...
                            <div class="row" style="display: block;">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('initials') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="initials" required="required" class="form-control k-textbox" data-role="text" placeholder="Initials" name="initials" type="text" value="{{ $student->initials }}">
                                    ...
                                    <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="last_name" class="form-control k-textbox" data-role="text" placeholder="Last Name" name="last_name" type="text" value="{{ $student->last_name }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}" style="display: block;">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="first_name" class="form-control k-textbox" data-role="text" required="required" placeholder="First Name" name="first_name" type="text" value="{{ $student->first_name }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('nic_number') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="nic_number" class="form-control k-textbox" data-role="text" required="required" placeholder="National Identity Card Number" data-parsley-minwords="10" name="nic_number" type="text" value="{{ $student->nic_number }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                                        ...
                                        <div class="controls col-sm-9">
                                            <input id="date_of_birth" class="form-control k-textbox" data-role="text" required="required" placeholder="Date of Birth"  name="date_of_birth" type="date" value="{{ $student->date_of_birth }}">
